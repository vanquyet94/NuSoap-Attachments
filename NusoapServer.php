...
class NusoapServer extends NusoapBase {
	...
	*/
	function __construct($wsdl=false){
		...
		if($wsdl){
			...
			if (is_object($wsdl) && (get_class($wsdl) == 'Modules\NuSoap\Wsdl')) {
				$this->wsdl = $wsdl;
	...
	*/
	function serialize_return() {
		...
		// if fault
		if (isset($this->methodreturn) && is_object($this->methodreturn) && ((get_class($this->methodreturn) == 'soap_fault') || (get_class($this->methodreturn) == 'Modules\NuSoap\NusoapFault'))) {
